...
abstract class AbstractWidget
{
    ...
    {
        // return '<div class="alert alert-light" role="alert"><i class="fas fa-cog fa-spin mr-1"></i>'.trans('Langcore::global.Loading').'</div>';
        return '';
    }
    ...
    public function container()
    {
        return [
            'element'       => 'div',
            'attributes'    => 'style="display:inline" class="vswwidget-widget-container"',
        ];
    }
    ...
    {
        return 'vswwidget.widgets.'.serialize($params);
    }
