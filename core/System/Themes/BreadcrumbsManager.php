...
use Vsw\Themes\Exceptions\DuplicateBreadcrumbException;
use Vsw\Themes\Exceptions\InvalidBreadcrumbException;
use Vsw\Themes\Exceptions\UnnamedRouteException;
use Vsw\Themes\Exceptions\ViewNotSetException;
...
class BreadcrumbsManager
{
     ...
     * @return void
     * @throws \Vsw\Themes\Exceptions\DuplicateBreadcrumbException If the given name has already been
     *     used.
     */
     ...
     * @throws \Vsw\Themes\Exceptions\UnnamedRouteException if no name is given and the current route
     *     doesn't have an associated name.
     * @throws \Vsw\Themes\Exceptions\InvalidBreadcrumbException if the name is (or any ancestor names
     *     are) not registered.
     */
     ...
     * @throws \Vsw\Themes\Exceptions\InvalidBreadcrumbException if the name is (or any ancestor names are) not registered.
     * @throws \Vsw\Themes\Exceptions\UnnamedRouteException if no name is given and the current route doesn't have an associated name.
     * @throws \Vsw\Themes\Exceptions\ViewNotSetException if no view has been set.
     */
    ...
    {
        // if (Theme::current() == CFglobal::cfn('theme')) {
        //     Theme::set(CFglobal::cfn('theme'));
        // } elseif (Theme::current() == CFglobal::cfn('admintheme'))  {
        //     Theme::set(CFglobal::cfn('admintheme'));
        // }
        if (Theme::current() == CFglobal::cfn('admintheme')) {
            Theme::set(CFglobal::cfn('admintheme'));
        } else {
            Theme::set(CFglobal::cfn('theme'));
        }
     ...
     * @throws \Vsw\Themes\Exceptions\UnnamedRouteException if the current route doesn't have an associated name.
     * @throws \Vsw\Themes\Exceptions\InvalidBreadcrumbException if the name is (or any ancestor names are) not registered.
     */
