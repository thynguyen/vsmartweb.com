...
["bootstrap4/signin-split", "bootstrap4/slider-header","bootstrap4/pricing-table", "bootstrap4/image-gallery", "bootstrap4/video-header", "bootstrap4/about-team", "bootstrap4/portfolio-one-column", "bootstrap4/portfolio-two-column", "bootstrap4/portfolio-three-column", "bootstrap4/portfolio-four-column"];

Vvveb.Blocks.add("bootstrap4/pricing-table", {
    name: "Bootstrap 4 Responsive Pricing Table",
  dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/product.png">',    
    image: "https://assets.startbootstrap.com/img/screenshots/snippets/pricing-table.jpg",
    html: `
