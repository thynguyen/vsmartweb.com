...
class UploadHandler
{
    ...
    protected function gd_create_scaled_image($file_name, $version, $options) {
        ...
        // Handle transfmparency in GIF and PNG images:
        switch ($type) {
            case 'gif':
            case 'png':
                imagecolortransfmparent($new_img, imagecolorallocate($new_img, 0, 0, 0));
            case 'png':
        ...
        if ($is_img)
        {
            ...
            if ( $thumbResult!==true)
            {
                if($thumbResult === false){
                    $res['files'][0]->error = transfm("Not enough Memory");
                }else{
