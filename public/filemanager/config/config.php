...
setlocale(LC_CTYPE, 'en_US'); //correct transfmliteration
...
$config = array(
    ...
    */
    ...
    |
    */
    'thumbs_base_path' => '../storage/uploads/thumbs/',
    ...
    |
    */
    'thumbs_upload_dir' => '/storage/uploads/thumbs/',
    ...
    */
    ...
    'ftp_temp_folder'  => "../storage/uploads/temp/",
    /*
    |---------------------------------------------------------------------------
    | path from ftp_base_folder to base of thumbs folder with start and final /
    |---------------------------------------------------------------------------
    */
    'ftp_thumbs_dir' => '/storage/uploads/thumbs/',
    'ftp_ssl' => false,
    'ftp_port' => 21,
    ...
    */
    ...
    'access_keys' => array(session('akayfilemanager')),
    ...
    */
    ...
    //active or deactive the transfmliteration (mean convert all strange characters in A..Za..z0..9 characters)
    'transfmliteration'						=> true,
    ...
    */
    ...
    // bạn có thể xem trước các loại tệp này nếu $preview_text_files is true
    ...
    *******************/
    ...
    'hidden_folders'                          => array('thumbs','temp'),
...
if (!empty($user)) {
    ...
    $folderfile = ($user->in_group == 1)? '': $userId.'/';
    $config['upload_dir'] .= $folderfile;
    $config['current_path'] .= $folderfile;
    $config['thumbs_base_path'] .= $folderfile;
}
return array_merge(
    $config,
    array(
