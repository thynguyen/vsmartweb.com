...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        var xhr = sbCorsRequest('GET', url + 'supportboard/include/init.php' + ('lang' in parameters ? '?lang=' + parameters['lang'] : '') + ('mode' in parameters ? ('lang' in parameters ? '&' : '?') + 'mode=' + parameters['mode'] : ''));
        ...
        if (!xhr) {
            ...
            xhr.onload = function () {
                ...
                sbCreateStyle(url + 'supportboard/css/min/' + (tickets ? 'tickets' : 'main') + '.min.css', head);
                sbCreateScript(url + 'supportboard/js/main.js', head);

                if (tickets) {
                    sbCreateScript(url + 'supportboard/apps/tickets/tickets.js', head);
                }
            };
