        ...
        <div class="sb-main">
            <div class="sb-bottom">
                ...
                <a href="http://board.support/changes" target="_blank" class="sb-btn-text">
                    <i class="sb-icon-clock"></i><?php sb_e('Changelog') ?>
                </a>
            </div>
        </div>
    </div>
...
function sb_component_admin() {
    ...
    $apps = [['SB_WP', 'wordpress', 'WordPress'], ['SB_SLACK', 'slack', 'Slack', 'Communicate with your users right from Slack. Send and receive messages and attachments, use emojis, and much more.'], ['SB_DIALOGFLOW', 'dialogflow', 'Dialogflow', 'Utilize an artificially intelligent chat bot to automatically answer your users\' questions and perform other complex tasks.'], ['SB_TICKETS', 'tickets', 'Tickets', 'Provide help desk support to your customers by including a tickets area with all the chat features into any web page.']];
...
?>
    <div class="sb-main <?php echo $logged ? 'sb-admin' : 'sb-admin-start' ?>" style="opacity: 0">
        ...
        <div class="sb-header">
            <div class="sb-admin-nav">
                ...
                <div>
                    ...
                    <?php if ($is_admin) echo '<a id="sb-users"><span>' . sb_('Users') . '</span></a><a id="sb-settings"><span>' . sb_('Settings') . '</span></a>' ?>
                </div>
            </div>
        ...
        <main>
                    ...
                    <div>
                        ...
                        <div class="sb-menu-wide sb-menu-users">
                            ...
                            <ul>
                                ...
                                <?php if ($active_user['user_type'] == 'admin') { echo '<li data-type="agent">' . sb_('Agents & Admins') . '</li>'; } ?>
                            </ul>
                        </div>
            ...
            <?php if ($active_user['user_type'] == 'admin') { ?>
...
function sb_departments($type) {
    ...
    if ($count) {
        switch ($type) {
            ...
            case 'custom-select':
                $code = '<div class="sb-inline"><h3>' . sb_('Department') . '</h3><div id="conversation-department" class="sb-select sb-select-colors"><p>' . sb_('General') . '</p><ul><li data-id="-1" data-value="-1">' . sb_('General') . '</li>';
                for ($i = 0; $i < $count; $i++) {
