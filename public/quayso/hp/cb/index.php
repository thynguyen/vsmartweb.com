						...
						<div class="d-flex justify-content-center">
							<div class="w-75 p-2 d-flex justify-content-center">
								<div class="form-check form-check-inline bg1">
								  <input class="form-check-input" type="radio" name="awards" id="awards1" value="1">
								  <label class="form-check-label" for="awards1">Giải đặc biệt</label>
								</div>
								<div class="form-check form-check-inline bg2">
								  <input class="form-check-input" type="radio" name="awards" id="awards2" value="2">
								  <label class="form-check-label" for="awards2">Giải nhất</label>
								</div>
								<div class="form-check form-check-inline bg3">
								  <input class="form-check-input" type="radio" name="awards" id="awards3" value="3">
								  <label class="form-check-label" for="awards3">Giải nhì</label>
								</div>
								<div class="form-check form-check-inline bg4">
								  <input class="form-check-input" type="radio" name="awards" id="awards4" value="4" checked>
								  <label class="form-check-label" for="awards4">Giải ba</label>
								</div>
							</div>
						</div>
					</div>
