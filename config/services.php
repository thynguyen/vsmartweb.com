...
return [
    ...
    */
    ...
    'facebook' => [
        ...
        'redirect'      => env('FACEBOOK_URL',false),
    ],
    'twitter' => [
        'client_id'     => env('TWITTER_CLIENT_ID',false),
        'client_secret' => env('TWITTER_CLIENT_SECRET',false),
        'redirect'      => env('TWITTER_URL',false),
    ],
    'google' => [
        'client_id'     => env('GOOGLE_CLIENT_ID',false),
        'client_secret' => env('GOOGLE_CLIENT_SECRET',false),
        'redirect'      => env('GOOGLE_URL',false),
    ],
];
